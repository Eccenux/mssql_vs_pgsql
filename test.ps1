...
Measure-Command {.\psql -U postgres --port 5433 -d test -c "update alog set deltaT = 0" > update.pg.log}

# pg text
Measure-Command {.\psql -U postgres --port 5433 -d test -c "update alog set url = left(url, 10)" > updatetxt.pg.log}
